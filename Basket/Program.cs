...
Console.WriteLine($"Global smallest basket value: {globalBasketStatistics.Min:N2}");
Console.WriteLine($"Global highest basket value: {globalBasketStatistics.Max:N2}");
...
Console.WriteLine($"Value of all baskets on the selected day: {dailyBasketStatistics.Sum:N2}");
Console.WriteLine($"Smallest basket value: {dailyBasketStatistics.Min:N2}");
Console.WriteLine($"Highest basket value: {dailyBasketStatistics.Max:N2}");
Console.WriteLine($"Average basket value: {dailyBasketStatistics.Average:N2}");